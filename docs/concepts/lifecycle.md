...
> **Status:** Design draft — v0.1 concepts. This is the narrative companion to the normative [execution pipeline](../architecture/execution-pipeline.md); stage numbers below refer to that document.
