...
> **Status:** Design draft — Proposed API. Assumes an existing oRPC app. Concepts: [capabilities](../concepts/capabilities.md); contract: [reference/metadata.md](../reference/metadata.md).
